$(function() {
	...
	lineDiagram("daly_line", "#daly_lineDiv", '#daly_lineTitle', `How much death and disability is caused by ${cause_name}?`, 
		...
		"DALYs per 100,000 people", "daly_lineDiv", "Disability-adjusted life years, 1990-2016, age standardized, rate");
...
$(function() {
	$.ajax({
		...
		svg.append("text")
			  ...
			  .attr("dy", "1em")
			  .style("text-anchor", "middle")
			  .text("DALYs per 100,000 people");      

		// Footer
		var containerDiv = document.getElementById("daly_lineDiv");
		var footer = document.createElement("p");
		var footer_text = document.createTextNode("Disability-adjusted life year rate, 1990-2016, age standardized, rate");
